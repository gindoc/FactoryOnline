...
public class DBHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "factoryOnline.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS WantedMessage "
                ...
                "update_time INTEGER NOT NULL, delete_id VARCHAR, update_id VARCHAR, owner_id VARCHAR, view_count INTEGER)");
