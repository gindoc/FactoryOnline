...
public class PublicationActivity extends BaseActivity<PublicationContract.View, PublicationPresenter> implements PublicationContract.View,SwipeRefreshLayout.OnRefreshListener, OnPageListener {
