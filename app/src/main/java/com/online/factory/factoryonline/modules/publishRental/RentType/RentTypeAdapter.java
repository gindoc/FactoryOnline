...
public class RentTypeAdapter extends BaseRecyclerViewAdapter<String, RentTypeAdapter.RentTypeViewHolder> {

    @Inject
    BehaviorSubject subject;

    @Inject
    public RentTypeAdapter(Context context) {
        super(context);
    }
    ...
    @Override
    public RentTypeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RentTypeViewHolder(linearLayout);
    }

    @Override
    public void onBindViewHolder(RentTypeViewHolder holder, final int position) {
    ...
    class RentTypeViewHolder extends RecyclerView.ViewHolder {

        public RentTypeViewHolder(View itemView) {
            super(itemView);
        }
    }
}
